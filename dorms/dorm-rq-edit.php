        ...
        ?>
                ...
                <div class="row">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <form method="POST" action="action.php?id=7&rqid=<?php echo $std_list['id']?>">
...
if($std_list['reason']==$rowP['id']){
                            ...
                            <div class="modal-footer">
                                <a href="?page=dorm-out-require" class="btn btn-warning btn-icon-split"><span class="icon text-black-50">
