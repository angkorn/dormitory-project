...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-7">
                            <div class="card shadow ">
                                ...
                                <p class="font-weight-bold" style="font-family: 'Anuphan';"><?php echo $rprefix['prefix'] . $row['name'] . ' ' . $row['surname'].' (สังกัด หอพัก'.$rdorm['dorm'].') '; ?></br>
                        ...
                        <div class="col-xl-6 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                <form method="POST" action="action.php?id=9">
        <div class="row">
  ...
  <div class="col-md-6 mb-3">
    <label for="exampleInputPassword1" class="form-label">รหัสผู้ใช้งาน/รหัสครูหอพัก</label>
    <input type="text" name="username" class="form-control" id="exampleInputPassword1" value="<?php echo $row['username'];?>" required>
  </div>
  </div>
  ...
  <input type="password" name="password" class="form-control" id="exampleInputEmail1" value="<?php echo $row['password'];?>" required>
  <div class="col-md-6 mb-3">
  ...
  <i class="fa-solid fa-floppy-disk"></i>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow ">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form method="POST" action="action.php?id=10">
                                    <div class="row">
                                    <input type="text" name="id" class="form-control" id="exampleInputEmail1" value="<?php echo $row['id'];?>" hidden>
